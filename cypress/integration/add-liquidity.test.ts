describe.only('Add Liquidity', () => {
  it('loads the two correct tokens', () => {
    cy.visit('/add/0x0e09fabb73bd3ade0a17ecc321fd13a19e81ce82/0xEfE40EC15b00FeC37047260f54b07cE701Aeb763')
    cy.get('#add-liquidity-input-tokena #pair').should('contain.text', 'CAKE')
    cy.get('#add-liquidity-input-tokenb #pair').should('contain.text', 'DUSD')
  })
  ...
  it('token not in storage is loaded', () => {
    cy.visit('/add/0xEfE40EC15b00FeC37047260f54b07cE701Aeb763/0x7083609fce4d1d8dc0c979aab8c869ea2c873402')
    cy.get('#add-liquidity-input-tokena #pair').should('contain.text', 'DUSD')
  ...
  it('single token can be selected', () => {
    ...
    cy.visit('/add/0xEfE40EC15b00FeC37047260f54b07cE701Aeb763')
    cy.get('#add-liquidity-input-tokena #pair').should('contain.text', 'DUSD')
  })
