...
import { Currency, currencyEquals, ETHER, Percent, WETH } from '@dynastyswap-libs/sdk'
import { Button, Flex, Text } from '@dynastyswap-libs/uikit'
                      ...
                      {chainId && (oneCurrencyIsWETH || oneCurrencyIsETH) ? (
                        <RowBetween style={{ justifyContent: 'flex-end' }}>
                          {oneCurrencyIsETH ? (
                            ...
                            >
                              {TranslateString(1188, 'Receive WDNY')}
                            </StyledInternalLink>
                          ) : oneCurrencyIsWETH ? (
                            <StyledInternalLink
                              to={`/remove/${currencyA && currencyEquals(currencyA, WETH[chainId]) ? 'DNY' : currencyIdA
                                }/${currencyB && currencyEquals(currencyB, WETH[chainId]) ? 'DNY' : currencyIdB}`}
                            >
                              {TranslateString(1190, 'Receive DNY')}
                            </StyledInternalLink>
                          ) : null}
                        </RowBetween>
                      ) : null}
